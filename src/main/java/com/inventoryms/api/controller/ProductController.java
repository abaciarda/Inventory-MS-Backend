...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> createProduct(
        ...
        ApiResponse<ProductResponse> response = new ApiResponse<>(true, "Product created successfully",
                productResponse);
    ...
    public ResponseEntity<ApiResponse<List<ProductResponse>>> getAllProducts() {
        ...
        ApiResponse<List<ProductResponse>> response = new ApiResponse<>(true, "Products fetched successfully",
                products);
